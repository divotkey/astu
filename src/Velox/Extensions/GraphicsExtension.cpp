...
/////////////////////////////////////////////////
    ...
    /**
     * Constructor function for UnicolorPattern items.
     */
    class UnicolorConstructor : public InterpreterFunction {
    public:
    ...
    protected:
        ...
        std::shared_ptr<Item> DoEvaluate(ScriptContext &sc, unsigned int lineNumber) override
        {
            ...
            // Consider optional color parameter.
            const auto &colorParam = sc.GetItem("color");
            if (colorParam.IsUndefined()) {
                newItem->SetData(make_shared<UnicolorPattern>());
            } else {
                newItem->SetData(make_shared<UnicolorPattern>(colorParam.GetColorValue()));
            }
    ...
    //class UnicolorSetColorFunction : public InterpreterFunction {
    //public:
    //
    //    /**
    //     * Constructor.
    //     */
    //    UnicolorSetColorFunction() = default;
    //
    //protected:
    //
    //    std::shared_ptr<Item> DoEvaluate(ScriptContext &sc, unsigned int lineNumber) override {
    //        auto unicolor = std::dynamic_pointer_cast<UnicolorPattern>(sc.FindItem("this")->GetData());
    //        assert(unicolor);
    //        return Item::CreateColor(unicolor->GetColor());
    //    }
    //};
    ...
    void GraphicsExtension::InjectExtension(Interpreter &interpreter) const
    {
        ...
        unicolorType->AddItem("SetColor", ExtensionFunctionOneParameter<UnicolorPattern>::CreateItem(
