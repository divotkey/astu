...
namespace astu {
    ...
    // size 3x3, radius = 1.0
    // const double AntiAliasingPatternRenderer::kKernel3x3[] = {
    ...
    // size 5x5, radius = 1.0
    // const double AntiAliasingPatternRenderer::kKernel5x5[] = {
    ...
    // size 7x7, radius = 1.5
    // const double AntiAliasingPatternRenderer::kKernel7x7[] = {
    ...
    // size 9x9, radius = 1.5
    // const double AntiAliasingPatternRenderer::kKernel9x9[] = {
    //     0.000072,	0.000323,	0.000944,	0.001794,	0.002222,	0.001794,	0.000944,	0.000323,	0.000072,
    //     0.000323,	0.00145,	0.004233,	0.008048,	0.00997,	0.008048,	0.004233,	0.00145,	0.000323,
    //     0.000944,	0.004233,	0.012358,	0.023496,	0.029106,	0.023496,	0.012358,	0.004233,	0.000944,
    //     0.001794,	0.008048,	0.023496,	0.044672,	0.055338,	0.044672,	0.023496,	0.008048,	0.001794,
    ...
    // const map<AntialiasingLevel, const double *> AntiAliasingPatternRenderer::kLevelToKernel = {
    ...
    // const map<AntialiasingLevel, unsigned int> AntiAliasingPatternRenderer::kLevelToSize = {
    ...
    // const map<AntialiasingLevel, double> AntiAliasingPatternRenderer::kLevelToRadius = {
    ...
    AntiAliasingPatternRenderer::AntiAliasingPatternRenderer(TransformMode mode, AntialiasingLevel aaLevel)
        : PatternRenderer(mode)
    ...
    void AntiAliasingPatternRenderer::DoRender(const Pattern & pattern, Image & result)
    {
        double dx = 1.0;
    ...
    Color4d AntiAliasingPatternRenderer::CalcColor(const Vector2<double> & p, const Pattern & pattern)
    {
        ...
        for (unsigned int j = 0; j < kKernelSize; ++j) {
            ...
            for (unsigned int i = 0; i < kKernelSize; ++i) {
                aa.x += dx;
                Color4d localColor;
                if (pattern.GetColor(transform.TransformPoint(aa), localColor)) {
                    c += localColor * (*k++);
                } else {
                    ++k;
                }
