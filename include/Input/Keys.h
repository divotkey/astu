...
namespace astu {
    ...
    public:
        ...
        /** Constant for key 'NumpadOne' */
        static const Key NumpadOne;

        /** Constant for key 'NumpadTwo' */
        static const Key NumpadTwo;

        /** Constant for key 'NumpadThree' */
        static const Key NumpadThree;

        /** Constant for key 'NumpadFour' */
        static const Key NumpadFour;

        /** Constant for key 'NumpadFive' */
        static const Key NumpadFive;

        /** Constant for key 'NumpadSix' */
        static const Key NumpadSix;

        /** Constant for key 'NumpadSeven' */
        static const Key NumpadSeven;

        /** Constant for key 'NumpadEight' */
        static const Key NumpadEight;

        /** Constant for key 'NumpadNine' */
        static const Key NumpadNine;

        /** Constant for key 'NumpadZero' */
        static const Key NumpadZero;

        /** Constant for key 'NumpadPeriod' */
        static const Key NumpadPeriod;
        ...
        /** Constant for 'Gamepad Left Shoulder' */
